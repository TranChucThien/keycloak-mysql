...
# Test token generation for Keycloak 18+ (Quarkus) without /auth prefix
# Usage: ./test-token-modern.sh [KEYCLOAK_URL] [USERNAME]
...
echo "🔐 Testing token generation for Keycloak Modern (KC18+)..."
